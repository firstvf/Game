...
public class Merchant : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        else
        {
            ...
            GameObject.Find("LightPotion_Text").GetComponent<TextMeshProUGUI>().text = "It's a good sword... I advise you to buy it!";
    ...
    public void BuyLightPotion()
    {
        if (_player.Money >= _purchaseValue && SceneManager.GetSceneByBuildIndex(2).isLoaded)
        {
            ...
            GameObject.Find("Light_Potion_Effect").GetComponent<UnityEngine.Rendering.Universal.Light2D>().intensity = 0.52f;
