...
public class PlayerData : MonoBehaviour
{
    ...
    public void GetDataToNewScene()
    {
        ...
        if (SceneManager.GetSceneByBuildIndex(3).isLoaded)
            GameObject.Find("Light_Potion_Effect").GetComponent<UnityEngine.Rendering.Universal.Light2D>().intensity = _light;
    ...
    public void SaveHealthAndMoney()
    {
        ...
        if (SceneManager.GetSceneByBuildIndex(2).isLoaded)
            _light = GameObject.Find("Light_Potion_Effect").GetComponent<UnityEngine.Rendering.Universal.Light2D>().intensity;
